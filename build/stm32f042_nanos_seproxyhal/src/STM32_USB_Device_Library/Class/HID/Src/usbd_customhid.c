...
USBD_ClassTypeDef const USBD_CUSTOM_HID = 
{
...
__ALIGN_BEGIN const uint8_t USBD_CUSTOM_HID_CfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
...
#else
const uint8_t CUSTOM_HID_ReportDesc[] = {
...
/* USB CUSTOM_HID device Configuration Descriptor */
__ALIGN_BEGIN const uint8_t USBD_CUSTOM_HID_Desc[] __ALIGN_END =
{
  /* 18 */
  0x09,         /*bLength: CUSTOM_HID Descriptor size*/
  CUSTOM_HID_DESCRIPTOR_TYPE, /*bDescriptorType: CUSTOM_HID*/
...
/* USB Standard Device Descriptor */
__ALIGN_BEGIN const uint8_t USBD_CUSTOM_HID_DeviceQualifierDesc[] __ALIGN_END =
{
...
/* Private variables ---------------------------------------------------------*/
const USBD_DescriptorsTypeDef HID_Desc = {
                              ...
                              uint8_t epnum, uint8_t* buffer)
{
  ...
  ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData)->OutEvent(buffer);
...
uint8_t USBD_CUSTOM_HID_EP0_RxReady(USBD_HandleTypeDef *pdev)
{
  ...
  {
    ((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData)->OutEvent(NULL);
